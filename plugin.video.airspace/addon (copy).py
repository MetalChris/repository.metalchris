...
artbase = 'special://home/addons/plugin.video.smithsonian-air.n.space/resources/media/'
_addon = xbmcaddon.Addon()
_addon_path = _addon.getAddonInfo('path')
selfAddon = xbmcaddon.Addon(id='plugin.video.smithsonian-air.n.space')
self = xbmcaddon.Addon(id='plugin.video.smithsonian-air.n.space')
translation = selfAddon.getLocalizedString
usexbmc = selfAddon.getSetting('watchinxbmc')
settings = xbmcaddon.Addon(id="plugin.video.smithsonian-air.n.space")
...
defaultimage = 'special://home/addons/plugin.video.smithsonian-air.n.space/icon.png'
defaultfanart = 'special://home/addons/plugin.video.smithsonian-air.n.space/fanart.jpg'
defaulticon = 'special://home/addons/plugin.video.smithsonian-air.n.space/icon.png'
baseurl = 'http://www.airspacemag.com'

local_string = xbmcaddon.Addon(id='plugin.video.smithsonian-air.n.space').getLocalizedString
...
def sc_videos(url):
	...
	for item in items:
	    ...
	    #key = (((image.split('jpeg')[0]).replace('_None',''))[-33:])[:32]
	    ...
	    #url = 'http://cf.c.ooyala.com/' + key + '/DOcJ-FxaFrRg4gtDEwOmk2OjBnO5K5Gd'
	...
	#print r.status_code# == 404:
		...
		print dtype
		    ...
		    if bitrate >= 1200:
		        ...
		        break
		i = i + 1
	    #try: url = (jgdata["authorization_data"][key]["streams"][3]["url"]["data"]).decode('base64')
	    #except NameError:
		#url = 'http://player.ooyala.com/player/all/' + key + '.m3u8'
		#play(url)
	    #play(url)
